...
const ProductsData = [
  ...
  { id: 6, img: img6, title: "Female suit" },
  { id: 7, img: img7, title: "Green T-shirt" },
  { id: 8, img: img8, title: "New Balance 993" }
]

// Duplicate for infinite loop effect
const loopData = [...ProductsData, ...ProductsData, ...ProductsData];

const Products = () => {
  return (
    <div className="py-3  mb-10 w-280 mx-auto a z-50 
      bg-white dark:bg-dark-three overflow-hidden">
      <div className="flex animate-scroll gap-8 w-max">

        {loopData.map((data, index) => (
          <div key={index} className="flex flex-col items-center gap-2 w-24">
            <div className="w-15 h-15 sm:w-15 sm:h-15 rounded-full overflow-hidden
