...
import img1 from "../assets/products/greenT.jpeg";
...
import img5 from "../assets/products/whiteT.jpeg";
...
const MensWearSection = ({ handleOrderPopup }) => {
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <div className="text-left">
              ...
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1 max-w-xl">
                Explore our most popular and highly rated Men curated for your everyday style.
              </p>
            </div>
              ...
              >
                ...
                <button
                    type="button"
                      ...
                      aria-label="Add to wishlist"                        className="absolute top-2.5 right-2.5 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white/70 dark:bg-black/40 text-gray-700 dark:text-gray-200 backdrop-blur-xs transition-all duration-200 hover:scale-110 hover:text-red-500 active:scale-90 shadow-xs">                        
                          {wishlist[data.id] ? (
                    ...
                    <Link
                      ...
                      text-gray-900 dark:text-white hover:bg-crown hover:text-white dark:hover:bg-hoverdark                             dark:hover:text-black backdrop-blur-xs shadow-md transition-all duration-200 cursor-pointer">
                        Quick View
                    </Link>
                  </div>
                </div>
